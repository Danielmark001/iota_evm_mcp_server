...
A comprehensive Model Context Protocol (MCP) server that provides blockchain services across multiple EVM-compatible networks. This server enables AI agents to interact with Ethereum, Optimism, Arbitrum, Base, Polygon, and many other EVM chains with a unified interface. Built for IOTA Angelhack Moveathon. 
...
git clone https://github.com/Danielmark001/iota_iota_evm_mcp_server.git
...
npx @Danielmark001/iota_evm_mcp_server

# Run the server in HTTP mode (for web applications)
npx @Danielmark001/iota_evm_mcp_server --http
```
...
5. Enter the following details:
   - Server name: `iota_evm_mcp_server`
   - Type: `command`
   - Command: `npx @Danielmark001/iota_evm_mcp_server`
...
```json
{
  "mcpServers": {
    "iota_evm_mcp_server": {
      ...
      "args": [
        "-y",
        "@Danielmark001/iota_evm_mcp_server"
      ]
    },
    "evm-mcp-http": {
      "command": "npx",
...
```bash
# Add the MCP server
claude mcp add iota_evm_mcp_server npx @Danielmark001/iota_evm_mcp_server
